...
class maths_QueS : AppCompatActivity(), View.OnClickListener {
    ...
    var cp: Int = 0
    private val mathsQuestions = Constants.getMathsQuestions()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_maths_ques)
        ...
        submit.setOnClickListener{
            if(selectedOption==0){
                ...
                optionsView()
                cp++;
                if(cp == mathsQuestions.size-1){
                    submit.text = "FINISH"
                }
                if(cp==mathsQuestions.size){
                    cp = 0
    ...
    public fun setQuestion(){
        val Question: Questions = mathsQuestions[cp]
